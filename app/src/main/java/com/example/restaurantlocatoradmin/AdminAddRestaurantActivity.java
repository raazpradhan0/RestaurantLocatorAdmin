...
public class AdminAddRestaurantActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private String Rname, Rdescription, downloadImageUrl,Rcatagory, productRandomKey,saveCurrentDate, saveCurrentTime, current_admin_id;
    private StorageReference restaurantImageRef;
    private DatabaseReference resrurantDatabaseRef, adminRef;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        current_admin_id = Prevalent.currentOnlineUser.getPhone();
    ...
    private void storedProductInformation()
    {
        ...
        adminRef.child(current_admin_id).addValueEventListener(new ValueEventListener()
        {
            @Override
    ...
    private void SaveProductInfoToDatabase()
    {
        ...
        restaurantMap.put("adminID",current_admin_id);
        restaurantMap.put("name",Prevalent.currentOnlineUser.getName());
        ...
        resrurantDatabaseRef.child(productRandomKey).updateChildren(restaurantMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task)
            {
                if (task.isSuccessful())
                {
                    Intent intent = new Intent(AdminAddRestaurantActivity.this, AdminHomeActivity.class);
